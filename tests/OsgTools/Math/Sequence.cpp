...
#include "OsgTools/Math/Sequence.h"
...
////////////////////////////////////////////////////////////////////////////////
//
//  Select the correct matrix and vec3 type.
//
////////////////////////////////////////////////////////////////////////////////
...
namespace Details
{
  ...
  {
    typedef osg::Matrixd matrix_type;
    typedef osg::Vec3d vec3_type;
  };
  template <> struct Selector < float >
  {
    typedef osg::Matrixf matrix_type;
...
{
  typedef TestType T;
  typedef Details::Selector < T > Selector;
  typedef typename Selector::matrix_type Matrix44;
  typedef typename Selector::vec3_type Vec3;
